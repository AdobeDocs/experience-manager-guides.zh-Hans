...
* **删除**：从输出列表中删除站点页面。 出现确认提示。 Once you confirm, the Sites page is removed from the **Outputs** list. But the Sites page is not deleted permanently.

* **View**: View the Sites page editor. 您还可以进行更改并保存它们。
