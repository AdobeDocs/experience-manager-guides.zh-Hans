...
搜索是即时的，这意味着当您在&#x200B;**查找**&#x200B;字段中键入搜索短语或单词时，将立即在主题中搜索和选择搜索词。 同样，要替换主题中的文本，请在相应的字段中输入搜索词及其替换词，然后单击&#x200B;**替换**&#x200B;或&#x200B;**全部替换**&#x200B;按钮。
...
- **外观**：选择Web编辑器应用程序的主题和内容编辑区域的源视图。
  ...
  用户首选项的![外观选项卡](images/user_preference_editor_appearance.png){width="550" align="left"}
   ...
   - **按**&#x200B;查看文件：选择在Web编辑器中查看文件的默认方式。 您可以在&#x200B;**创作**&#x200B;视图的各个面板中按标题或文件名查看文件列表。
...
您可以通过提供图像文件的“高度”或“宽度”值来调整图像的大小。 图像的纵横比会自动得到保持。 If you want, you can also choose not to maintain the aspect ratio of the image file by clicking the lock icon \(of Maintain Aspect Ratio\) and providing Height and Width values.
...
>[!NOTE]
>
> While adding a YouTube video link, you need to replace the string `watch?v=` with `embed` in the URL. 例如，要添加YouTube视频链接： `https://www.youtube.com/**watch?v**=WlIKQOrmZcs`，您需要将其添加为： `https://www.youtube.com/**embed/**WlIKQOrmZcs`。 此更改可确保在AEM Site和PDF输出中嵌入视频。
...
**插入可重复使用的内容** - ![](images/content-reuse-icon.svg)
...
>[!NOTE]
>
> 如果用户从Web编辑器中启用标记视图，则即使跨会话，该视图也会保持启用状态。 这意味着您无需再次启用标记视图即可稍后访问它。新用户会话的“标记视图”的默认值由ui\_config.json文件中的tagsView属性决定。 有关更多详细信息，请参阅安装和配置Adobe Experience Manager Guides as a Cloud Service中的&#x200B;*为标记视图配置默认值*&#x200B;部分。
...
1. 您还可以在&#x200B;**版本历史记录**&#x200B;对话框中查看以下信息：
   ...
   **元数据**&#x200B;选项卡：新添加的元数据为绿色字体，已删除的元数据为红色字体。
   版本的![元数据差异 &#x200B;](images/metadata-version-diff.png){width="550" align="left"}
   *在版本历史记录中比较不同版本的元数据。*
...
By default, you can view the files by titles. 当您将鼠标悬停在文件上时，您可以作为工具提示查看文件标题和文件路径。
...
- 在编辑器中右键单击文件的选项卡以打开上下文菜单。 选择&#x200B;**添加到** > **收藏夹**&#x200B;以将文件添加到收藏夹列表。
...
*应用筛选器以搜索包含文本`general purpose.`*&#x200B;的文件
...
如果您对映射文件具有编辑权限，则也可以编辑这些文件。 有关通过DITA映射打开和编辑主题的详细信息，请参阅[通过DITA映射编辑主题](map-editor-advanced-map-editor.md#id17ACJ0F0FHS)。
...
- Clicking on an element in the Outline View selects the element&#39;s content in the Author or Source view.“大纲”视图与“创作”视图和“Source”视图保持同步。 如果在任何视图中进行了任何更改，则可在“大纲”视图中看到这些更改。 例如，如果在“创作”视图中添加段落或更新元素，则它将显示在“大纲”视图中。
...
**词汇表** - ![](images/glossary.svg)

通过AEM Guides，您可以轻松创建和使用术语表类型文档。 您可以创建术语表主题文件，然后将其包含在通用术语表映射中。 将此映射添加为根映射后，术语表条目将显示在“术语表”面板中。

![](images/glossary-panel.png){width="650" align="left"}

要从术语表中插入术语，只需将该条目从面板拖放到主题中的所需位置即可。 词汇表术语的“选项”菜单允许您快速获取条目术语的&#x200B;**预览**、条目术语文件的&#x200B;**复制路径**，或者在存储库中查找条目术语文件。
...
- **词汇表键**：从要用于选定主题搜索的DITA映射中选择词汇表键。 选定的键将显示如下。 您可以通过单击&#x200B;**删除**&#x200B;图标来删除选定的键。

- **主题**：选择在Web编辑器中打开的&#x200B;**当前主题**、在当前映射中打开的所有&#x200B;**主题**&#x200B;或在映射编辑器中编辑的&#x200B;**当前映射**&#x200B;以搜索术语。
...
- **选项**：您可以从以下选项中进行选择：
   ...
   - **转换前签出文件**：搜索的文件在转换术语前已签出。
   - **转换后创建新版本**：在术语转换完成之后创建主题的新版本。
- 如果您为每个主题&#x200B;**选项选择**&#x200B;手动，则会显示&#x200B;**下一步**&#x200B;按钮。 单击&#x200B;**下一步**&#x200B;以根据所选设置转换每个主题的术语。 它会提示您转换每个主题中的术语并移到下一个文件。 您可以选择转换术语或跳过它并移到下一个术语。

  ![](images/manual-convert-skip.png){width="300" align="left"}

- 如果选择&#x200B;**自动为所有主题设置**&#x200B;选项，将显示&#x200B;**转换**&#x200B;按钮。 选择&#x200B;**转换**&#x200B;以将文档中找到的所有术语转换为链接的术语缩写。

显示已更新的&#x200B;**主题**&#x200B;的列表，其中包含已转换的术语和&#x200B;**出错的主题**。 将鼠标悬停在有错误的主题附近的\(![](images/info-icon.svg)\)图标上可查看错误的详细信息。
...
AEM Guides还支持嵌套级别主题方案映射，并且您可以在根主题方案映射下定义多个主题方案。

以下示例演示了如何在AEM Guides中使用主题方案。
...
若要从“条件”面板查看主题方案，系统管理员必须在“编辑器设置”的“条件”选项卡下，选择“条件”面板中的&#x200B;**显示主题方案**&#x200B;选项。 有关详细信息，请参阅[条件选项卡](#id21BMNE0602V)。
...
- 单击代码片段旁边的+图标以打开新建代码片段对话框。
  ...
  在“新建代码片段”对话框中，提供显示在“代码片段”面板中的标题、描述以及要创建的代码片段内容的XML代码。 单击&#x200B;**创建**&#x200B;保存并创建代码片段。

- 在内容编辑区域中，右键单击要用作代码片段的元素的痕迹导航，然后从上下文菜单中选择&#x200B;**创建代码片段**。 此时将显示“新建代码片段”对话框，并在&#x200B;**Content**&#x200B;字段中填充了选定元素的XML代码。 输入该代码片段的&#x200B;**标题**&#x200B;和&#x200B;**描述**，然后单击&#x200B;**创建**&#x200B;保存该代码片段。

- 在内容编辑区域中，右键单击要用作代码片段的内容的任意位置，然后从上下文菜单中选择&#x200B;**创建代码片段**。 此时将显示“新建代码片段”对话框，并在&#x200B;**Content**&#x200B;字段中填充了选定元素的XML代码。 输入该代码片段的&#x200B;**标题**&#x200B;和&#x200B;**描述**，然后单击&#x200B;**创建**&#x200B;保存该代码片段。
...
“模板”面板仅对管理员可用。 使用此面板，管理员可以轻松地创建和管理随后可供作者使用的模板。 默认情况下，模板在&#x200B;*映射*&#x200B;和&#x200B;*主题*&#x200B;类型模板下分类。
...
>[!NOTE]
>
> 作为管理员，您还可以选择在Web编辑器中查看文件列表。 在&#x200B;**用户首选项** ![](images/user_preference_editor_icon.svg)中选择&#x200B;**按**&#x200B;查看文件部分的&#x200B;**文件名**&#x200B;选项。

要创建模板，请单击模板旁边的+图标，然后选择要创建的模板。 如果选择&#x200B;**主题模板**，则会显示“创建新主题模板”对话框：

![](images/create-new-topic-template.PNG){width="400" align="left"}

从&#x200B;**模板**&#x200B;下拉列表中选择要创建的模板类型。 提供“模板”面板中显示的&#x200B;**标题**。 根据标题自动建议模板的&#x200B;**名称**，但您可以提供其他文件名。
...
AEM Guides提供用于显示项目中所有审阅任务的功能。 您可以在&#x200B;**审阅**&#x200B;面板中查看您所属的审阅项目中的所有审阅项目和活动审阅任务。  然后，可打开审阅任务以查看各种审阅人的注释。
...
1. 选择审核![](images/active-review-tasklist-icon.svg)   在左侧面板上。 将打开&#x200B;**审阅**&#x200B;面板。  系统将显示您所属的审阅项目中的所有审阅项目和活动审阅任务。
...
>[!NOTE]
>
> 作为管理员，您还可以选择在Web编辑器中查看文件名列表。 在&#x200B;**用户首选项** ![](images/user_preference_editor_icon.svg)中选择&#x200B;**按**&#x200B;查看文件部分的&#x200B;**文件名**&#x200B;选项。

要执行全局搜索和替换，请执行以下步骤：

1. 打开全局&#x200B;**查找和替换**&#x200B;面板。
1. 单击&#x200B;**查找**&#x200B;下拉列表选择以下选项之一来执行搜索。
...
1. 您可以单击&#x200B;**选项**&#x200B;下拉菜单并从以下选项中进行选择：
   ...
   - **替换前签出文件**：如果您要在替换搜索词前自动签出文件，请选择此选项。 如果您的管理员启用了配置以在编辑之前签出文件，则此设置更相关。 启用后端设置后，您应该选择此选项。 它将会阻止文件签出对话框在做出任何更改之前提示您签出每个文件。 如果不选择此选项，则在打开文件进行编辑之前将显示提示。
...
1. 按Enter或选择&#x200B;**搜索**&#x200B;图标\(![](images/search-icon.svg)\)以执行搜索。
1. 从搜索结果列表中选择文件。 文件在内容编辑区域中打开，搜索词在内容中突出显示。
1. 单击&#x200B;**替换单次匹配项** \( ![](images/replace-icon.svg)\)以替换主题中当前突出显示的搜索词，或单击“下一个匹配项”![](images/next-match-in-search.png)或“上一个匹配项”![](images/previous-match-in-search.png)以移动到文本的下一个或上一个匹配项。
1. 单击&#x200B;**替换文件**&#x200B;中的所有项\(![](images/replace-all-in-file-icon.svg)\)可在单击时使用替换项替换单个文件中搜索项的所有匹配项。 替换选定文件中的所有匹配项后，您会看到通知。

   >[!NOTE]
   >
   > 将鼠标悬停在搜索结果列表中的文件上，可在文件右侧看到全部替换文件图标。 您还可以获得“忽略文件”图标以从搜索结果中删除文件。 您忽略的文件将从列表中删除，搜索词不会替换在其中。

1. 单击列表顶部右侧的&#x200B;**全部替换** \( ![](images/replace-all-in-file-icon.svg)\)，只需一次单击即可使用替换项替换所有文件中搜索项的所有匹配项。

   >[!NOTE]
   >
   > 要启用&#x200B;**全部替换**&#x200B;图标，系统管理员必须在&#x200B;**编辑器设置**&#x200B;的&#x200B;**常规**&#x200B;选项卡下选择选项&#x200B;**启用全部替换**。
...
>[!NOTE]
>
> 作为管理员，您还可以选择在选项卡中按文件名查看文件列表。 在&#x200B;**用户首选项** ![](images/user_preference_editor_icon.svg)中选择&#x200B;**按**&#x200B;查看文件部分的&#x200B;**文件名**&#x200B;选项。
...
通过选择右侧面板中的&#x200B;**内容属性**&#x200B;图标，您可以访问&#x200B;**内容属性**&#x200B;功能。 **内容属性**&#x200B;面板包含有关文档中当前选定元素的类型及其属性的信息。
...
1. 在&#x200B;**属性**&#x200B;下拉面板中，从下拉列表中选择属性并指定属性的值。  然后单击&#x200B;**添加**。
...
如果管理员为属性创建了配置文件，则您将获得这些属性及其配置值。 使用“内容属性”面板，您可以选择这些属性，并将它们分配给主题中的相关内容。 这样您也可以创建条件内容，然后将其用于创建条件输出。 有关使用条件预设生成输出的详细信息，请参阅[使用条件预设](generate-output-use-condition-presets.md#)。



**文件属性** - ![](images/topic-properties-icon.svg)

通过单击右侧面板中的文件属性![](images/topic-properties-icon.svg)图标查看所选文件的属性。 “文件属性”功能在所有四种模式或视图中均可用：布局、创作、Source和预览。
...
- **创建日期**：显示创建主题的日期和时间。
- **签出者**：显示签出该主题的用户。
- **文档状态**：您可以选择并更新当前已打开主题的文档状态。 有关更多详细信息，请参阅[文档状态&#x200B;](web-editor-document-states.md#)*。*
...
- **Used In**： Used In引用列出了引用或使用当前文件的文档。
...
**注意：**&#x200B;所有用于和传出引用均超链接到该文档。 您可以轻松打开和编辑链接的文档。

除了打开文件之外，您还可以使用“引用”部分中的&#x200B;**选项**&#x200B;菜单执行许多操作。 您可以执行的某些操作包括“编辑”、“预览”、“复制UUID”、“复制路径”、“添加到收藏夹”、“属性”和“打开映射仪表板”。
...
有关详细信息，请参阅[地址审核评论](review-address-review-comments.md#)。
...
>[!NOTE]
>
> 跟踪的更改功能显示已使用主工具栏的启用/禁用跟踪更改功能跟踪的所有更新。 有关详细信息，请参阅[启用/禁用跟踪更改](#id205DF0203Y4)。
