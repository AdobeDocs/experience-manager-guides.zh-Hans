...
- [发行版信息](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-guides/using/release-info/aem-guides-releases-roadmap){target="_blank"}
- 用户指南（旧UI） {#user-guide}
   - 简介 {#about-aem-guide}
...
- [用户指南（新UI）](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-guides/using/user-guide/about-aemg/intro)
