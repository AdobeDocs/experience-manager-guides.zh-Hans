...
- AEM Guides集成的端到端工作演示
   - 按JIRA中的更改内容更新网站和PDF上的发行说明


## 相关资源

- **在Experience League上配置数据源连接器** - [&#128279;](https://experienceleague.adobe.com/docs/experience-manager-guides/using/install-guide/cs-ig/web-editor-configs-cs/conf-data-source-connector-tools.html?lang=en)
...
- **使用Experience League上的Velocity模板工具** - [&#128279;](https://experienceleague.adobe.com/docs/experience-manager-guides/using/user-guide/author-content/create-preview-topics/author-content-aem-guides/work-with-web-editor/web-editor-content-snippet.html?lang=en#use-velocity-tools)
