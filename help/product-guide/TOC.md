      ...
      - 云服务 {#cloud-release-notes}
         ...
         - 2026版 {#2026-releases}
            ...
            - 2026.03.0发行版 {#2603-release}
               ...
               - [修复的问题](./release-info/fixed-issues-2026-03-0.md)
               - [升级说明](./release-info/upgrade-instructions-2026-03-0.md)
...
- 用户指南（新UI） {#user-guide}
   ...
   - 管理学习内容 {#learning-training-content}
      - 快速入门指南 {#get-started}
         - 简介 {#intro-lc}
            - [发行说明](./release-info-lt/release-notes-lt-2025-12-v2.md)
            - [发行说明](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- 安装和配置 {#install-guide}
   - 内部部署 {#on-prem-ig}
      ...
      - 编辑器设置 {#editor-configs}
         - [配置编辑器设置](./install-guide/editor-settings.md)
      ...
      - 使用输出生成设置 {#output-gen-config}
         ...
         - [AEM Sites的组件映射](./install-guide/component-mapping.md)
      ...
      - 使用DITA assets复制{#dita-assets-replication}
         - [配置DITA Assets复制](./install-guide/configure-dita-asset-replication.md)
   ...
   - 云服务 {#cs-ig}
      ...
      - 部署和配置AEM Guides as Cloud Service {#deploy-conf-aemg-cs}
         ...
         - [升级AEM Guides as Cloud Service的其他配置](./cs-install-guide/additional-config-for-cloud-service.md)
      ...
      - 使用输出生成设置 {#output-gen-config-cs}
         ...
         - [AEM Sites的组件映射](./cs-install-guide/component-mapping.md)
