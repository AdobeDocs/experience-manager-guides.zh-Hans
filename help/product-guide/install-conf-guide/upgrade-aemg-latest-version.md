...
使用AEM Guides更新了damAssetLucene的索引定义。 升级到所需版本后，请参阅[本文](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-16460)以重新索引damAssetLucene。
