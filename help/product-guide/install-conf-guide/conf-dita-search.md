...
以下选项卡提供了有关如何根据Experience Manager Guides设置向搜索序列化文件中添加自定义DITA元素或属性的说明：Cloud Service或内部部署。
...
以下选项卡提供了有关如何根据您的Experience Manager Guides设置在`configMgr`中启用元数据提取选项的说明： Cloud Service或内部部署。

>[!BEGINTABS]

>[!TAB Cloud Service]

使用[配置覆盖](download-install-config-override.md#)中提供的说明创建配置文件。 在配置文件中，提供以下\(property\)详细信息以配置元数据提取选项：
...
以下选项卡提供了有关如何根据您的Experience Manager Guides设置从搜索中排除临时翻译文件夹的说明： Cloud Service或内部部署。
