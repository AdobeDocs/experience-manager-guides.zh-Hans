...
7. [在文件夹配置文件中配置智能建议](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)
...
1. 切换到&#x200B;**配置**&#x200B;选项卡。
1. 将JSON服务详细信息（在上一部分中下载）粘贴到与`SERVICE_ACCOUNT_DETAILS`对应的&#x200B;**值**&#x200B;字段中。 请确保您使用以下屏幕快照中给出的相同名称和配置。

   ![ims服务帐户配置](assets/ims-service-account-config.png){width="800"}

## 在环境中启用AI标记

要在Experience Manager Guides UI上启用AI助手功能，请在环境中添加`ENABLE_GUIDES_AI`标志。
...
有关详细信息，请参阅[在文件夹配置文件](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)中配置智能建议。
