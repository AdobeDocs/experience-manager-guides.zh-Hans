...
以下选项卡提供了根据Experience Manager Guides设置翻译内容的说明：Cloud Service或内部部署。
...
以下选项卡提供了有关如何根据您的Experience Manager Guides设置在DITA映射仪表板上隐藏“翻译”选项卡的说明： Cloud Service或内部部署。
...
默认情况下，“隐藏翻译选项卡”选项未启用，您需要从configMgr中启用它。
...
以下选项卡提供了基于您的Experience Manager Guides设置的翻译工作流的说明：Cloud Service或内部部署。

>[!BEGINTABS]

>[!TAB Cloud Service]

根据设置中使用的翻译工作流，应配置基于组件的翻译工作流选项。 使用[配置覆盖](download-install-config-override.md#)中提供的说明创建配置文件。 在配置文件中，提供以下\（属性\）详细信息以配置基于组件的翻译工作流：
...
以下选项卡提供了根据Experience Manager Guides设置配置此选项的说明：Cloud Service或内部部署。
...
使用[配置覆盖](download-install-config-override.md#)中提供的说明创建配置文件。 在配置文件中，提供以下（属性）详细信息以配置旧版翻译工作流：
...
>[!IMPORTANT]
> 
> 建议您使用AEM Guides 4.6.0及更高版本中提供的最新翻译工作流以提高性能。 但是，如果您在翻译流程中启用了任何自定义设置，并且它受新工作流的影响，请考虑还原旧版翻译工作流作为解决方法。 默认情况下，旧版翻译工作流选项处于禁用状态。
...
使用[配置覆盖](download-install-config-override.md#)中提供的说明创建配置文件。 在配置文件中，提供以下\(property\)详细信息以配置临时语言副本的后处理：
