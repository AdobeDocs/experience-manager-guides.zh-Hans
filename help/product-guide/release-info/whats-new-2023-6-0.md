...
description: 了解Adobe Experience Manager Guides as a Cloud Service 2023年6月版的新增功能和增强功能
...
本文介绍Adobe Experience Manager Guides版本2023年6月中的新增功能和增强功能（以后称为&#x200B;*AEM Guides as a Cloud Service*）。
...
有关更多详细信息，请参阅[为草稿文档向PDF输出添加水印](../native-pdf/use-javascript-content-style.md#watermark-draft-document)。
...
* 单击&#x200B;**指南**&#x200B;图标(![](assets/aem-guides-icon.png))以返回AEM导航页面。


有关详细信息，请参阅[AEM导航页面](../user-guide/web-editor-launch-editor.md#id2056BG00RZJ)。
