---
title: 发行说明 | 2024.06.0版Adobe Experience Manager Guides的新增功能
description: 了解Adobe Experience Manager Guides as a Cloud Service 2024.06.0版本中的新增功能和增强功能。
...
![文件属性选项选项卡](./assets/file-properties-outputs-tab.png){width="300"}
...
![环绕元素对话框](./assets/surround-element.png) {width="300"}
...
Experience Manager Guides还支持本机PDF发布中的Markdown文档。 此功能非常方便，可帮助您为DITA map中的Markdown文件生成PDF。 本机PDF发布中的Markdown支持可帮助您轻松创建、管理和共享文档。
