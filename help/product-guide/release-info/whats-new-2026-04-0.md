---
title: 发行说明| Adobe Experience Manager Guides 2026.04.0版中的新增功能
description: 了解Adobe Experience Manager Guides 2026.04.0版本中的新增功能和增强功能
role: Leader
...
# 2026.04.0版（2026年4月）的新增功能

本文介绍Adobe Experience Manager Guides as a Cloud Service 2026.04.0版本中引入的新增功能和增强功能。

有关此版本中修复的问题列表，请查看 [2026.04.0 版本中已修复的问题](fixed-issues-2026-04-0.md)。

了解2026.04.0版本[的](../release-info/upgrade-instructions-2026-04-0.md)升级说明。
