---
title: 发行说明 | Adobe Experience Manager Guides 2025.08.0版本中的升级说明和修复的问题
description: 了解兼容性矩阵以及如何升级到Adobe Experience Manager Guides as a Cloud Service的2025.08.0版本。
...
本文介绍Adobe Experience Manager Guides as a Cloud Service 2025.08.0版的升级说明和兼容性矩阵。
...
本节介绍Experience Manager Guides as a Cloud Service 2025.08.0版本支持的软件应用程序的兼容性矩阵。

### FrameMaker和FrameMaker Publishing Server

| Experience Manager Guides as a Cloud | FMPS | FrameMaker |
| --- | --- | --- |
| 2025.08.0 | 不兼容 | 2022或更高版本 |
