---
title: 发行说明 | Adobe Experience Manager Guides 5.0.0 Service Pack 3版本的升级说明
description: 了解兼容性矩阵以及如何升级到Adobe Experience Manager Guides的5.0.0 Service Pack 3版本。
...
# 5.0.0 Service Pack 3版本（2026年2月）的升级说明

本文介绍了适用于Adobe Experience Manager Guides 5.0.0 Service Pack 3版本的升级说明和兼容性矩阵。

有关此版本中已修复的问题的列表，请查看[5.0.0 Service Pack 3版本](../release-info/fixed-issues-5-0-0-sp3.md)中已修复的问题。

## 兼容性矩阵

本部分列出了Experience Manager Guides 5.0.0 Service Pack 3版本支持的软件应用程序的兼容性矩阵。
...
| 发行版本 | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 3 (UUID) | 支持 | 2022或更高版本 |
...
## 升级到Experience Manager Guides的5.0.0 Service Pack 3版本

您可以轻松地将当前版本的Guides升级到5.0.0 Service Pack 3版。 在继续升级到Experience Manager Guides的5.0.0版Service Pack 3之前，您必须考虑以下几点：

- 如果您使用的是版本5.0.0 Service Pack 2、5.0.0 Service Pack 1或5.0.0，则可以直接升级到版本5.0.0 Service Pack 3。
