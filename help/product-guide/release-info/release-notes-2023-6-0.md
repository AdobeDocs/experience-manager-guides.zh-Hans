...
# 2023年6月版Adobe Experience Manager Guides as a Cloud Service

此发行说明涵盖了升级说明、兼容性矩阵，以及Adobe Experience Manager Guides版本2023年6月(以后称为&#x200B;*AEM Guides as a Cloud Service*)中修复的问题。
...
2. 将云服务Git代码的`<dox.version>`文件中的`/dox/dox.installer/pom.xml`属性更新为2023.6.297。
3. 提交更改并运行云服务管道，以升级到AEM Guides as a Cloud Service的2023年6月版本。
...
(仅限您使用的版本低于2022年9月发行的AEM Guides as a Cloud Service)
...
本部分列出了AEM Guides as a Cloud Service 2023年6月版本支持的软件应用程序的兼容性矩阵。
