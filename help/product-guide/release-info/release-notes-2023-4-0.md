...
# 2023年4月版的Adobe Experience Manager Guidesas a Cloud Service

此发行说明涵盖了升级说明、兼容性矩阵，以及Adobe Experience Manager Guides版本2023年4月中修复的问题(后称为&#x200B;*AEM Guidesas a Cloud Service*)。

有关新增功能和增强功能的更多信息，请参阅[AEM Guidesas a Cloud Service2023年4月版的新增功能](whats-new-2023-4-0.md)。
...
2. 将Cloud ServiceGit代码的`/dox/dox.installer/pom.xml`文件中的`<dox.version>`属性更新为2023.4.249。
3. 提交更改并运行Cloud Service管道，以升级到AEM Guidesas a Cloud Service的2023年4月版。
...
本部分列出了AEM Guides as a Cloud Service2023年4月版本支持的软件应用程序的兼容性矩阵。
...
Adobe已发现AEM Guides 2023年4月as a Cloud Service版本的以下已知问题。
