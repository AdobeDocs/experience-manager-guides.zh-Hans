...
1. 将Cloud Services Git代码的`/dox/dox.installer/pom.xml`文件中的`<dox.version>`属性更新为2022.1.78。
...
* 已添加新的配置，以允许用户保留或删除在AEM站点输出生成中使用&#x200B;**删除和创建**&#x200B;选项时要删除的主题版本。
...
* 使用键盘快捷键Alt+Enter打开插入元素对话框时，光标未显示在搜索栏中。(7912)
