---
title: 发行说明 | 2025.06.0版Adobe Experience Manager Guides中的升级说明和修复的问题
...
本文介绍Adobe Experience Manager Guides as a Cloud Service 2025.06.0版的升级说明和兼容性矩阵。
...
本节介绍Experience Manager Guides as a Cloud Service 2025.06.0版本支持的软件应用程序的兼容性矩阵。

### FrameMaker和FrameMaker Publishing Server

| Experience Manager Guides as a Cloud | FMPS | FrameMaker |
| --- | --- | --- |
| 2025.06.0 | 不兼容 | 2022或更高版本 |
