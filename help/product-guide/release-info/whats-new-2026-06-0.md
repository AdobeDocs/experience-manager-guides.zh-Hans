...
了解2026.06.0版本[&#128279;](../release-info/upgrade-instructions-2026-06-0.md)的升级说明。
...
- 创建学习内容时，您现在可以使用多行文本输入字段。 此增强功能支持在单个字段中使用换行符和文本换行，因此无需依赖自定义脚本，即可更轻松地捕获较长的学习者响应。 在“插入”菜单[&#128279;](../learning-content/lc-other-insert-options.md)中了解有关其他选项的更多信息。
