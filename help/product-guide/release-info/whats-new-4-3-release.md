...
![添加本机pdf元数据](assets/native-pdf-metadata-asset.png){width="300" align="left"}
...
文件的![选项菜单](assets/rename-move-assets.png){width="550" align="left"}
...
![断开的链接报告](assets/broken-link-report.png){width="800" align="left"}
