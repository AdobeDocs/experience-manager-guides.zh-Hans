...
| 发行版本 | 事件 | 计划 | 新增功能 | 升级说明 | 修复的问题 | 状态 |
|---|---|---|---|---|---|---|
| Adobe Experience Manager Guides 2026.03.0 <br> [（AEM版本 — 24893）](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest) | 自动更新 | 2026 年 3 月 23-25 日 | [此处](whats-new-2026-03-0.md) | [此处](upgrade-instructions-2026-03-0.md) | [此处](fixed-issues-2026-03-0.md) | 已更新 |
...
|---|---|---|---|---|---|
| Adobe Experience Manager Guides 5.2.0 | 发行版本 | 2026年4月第二周 | - | - | Target |
