...
description: 了解Adobe Experience Manager Guides as a Cloud Service 2023年10月版的新增功能和增强功能。
...
本文介绍2023年10月版本的Adobe Experience Manager Guides（以后称为&#x200B;*AEM Guides as a Cloud Service*）中的新增功能和增强功能。
...
数据源面板中列出了![数据源连接器](assets/data-sources-create-window.png){width="550"}
...
存储库视图中文件的![选项菜单](assets/options-menu-repo-view-file-level-2310.png){width="550"}
