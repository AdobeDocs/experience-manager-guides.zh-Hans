...
现在，您可以在映射中搜索包含特定文本的文件。 搜索到的文本将在文件中突出显示。 您也可以使用文件中的其他单词或短语替换搜索的单词或短语。 选择&#x200B;**替换单个匹配项**&#x200B;图标以替换当前匹配项，选择&#x200B;**替换文件中的所有匹配项**&#x200B;图标以替换选定文件中的所有匹配项。 您可以选择&#x200B;**全部替换**&#x200B;图标以替换所有文件中搜索词的所有匹配项。
