...
![文件属性选项选项卡](./assets/file-properties-outputs-4-6.png) {width="300"}

*从&#x200B;**文件属性**.*&#x200B;中的&#x200B;**输出**&#x200B;部分发布并查看主题的体验片段

Experience Manager Guides现在允许您将主题或其元素发布到体验片段。 您可以在主题或其元素与体验片段模板之间创建基于JSON的映射。 您还可以使用条件过滤器创建体验片段变量。

详细了解如何[发布体验片段](../user-guide/publish-experience-fragment.md)。
...
![在“作为内容片段发布”对话框中添加片段模型和映射详细信息](assets/content-fragment-mapping.png)
...
![添加元数据本机pdf](./assets/add-metadata-native-pdf.png) {width="300"}
...
### 在本地PDF发布中支持Markdown文档

Experience Manager Guides还支持本机PDF发布中的Markdown文档。 此功能非常方便，可帮助您为DITA map中的Markdown文件生成PDF。
...
以嵌套层次结构组织的![条件](assets/conditions-nested-hierarchy.png){width="300"}
