...
1. 要更新元数据，请选择要更新的文件。 通过选中显示在&#x200B;**Title**&#x200B;旁边的复选框，可以选择出现在元数据面板中的文件。
   ...
   >[!NOTE]
   >
   > 如果某个文件被其他用户锁定，则无法选择该文件来更新元数据。 锁定图标也会出现在锁定文件的标题附近。 您可以将鼠标悬停在图标上以查看用户的名称。 您可以将&#x200B;**管理**&#x200B;按钮配置为在所选文件处于只读模式时将其禁用。 有关详细信息，请在“元数据”面板[&#128279;](../guides-ui-extensions/examples.md)上查看管理按钮。
   >
