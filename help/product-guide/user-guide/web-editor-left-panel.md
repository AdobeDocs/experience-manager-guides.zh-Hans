...
>[!NOTE]
>
> 从2025.11.0版本开始，编辑器中的&#x200B;**存储库**&#x200B;将被弃用，并由&#x200B;**云服务**&#x200B;安装程序的&#x200B;**资源管理器**&#x200B;替换。 对于&#x200B;**内部部署**&#x200B;设置，在Experience Manager Guides版本5.1之前，您将继续通过编辑器界面查看和使用存储库。
...
>[!NOTE]
>
> 从2025.11.0版本开始，编辑器中的存储库一词将被&#x200B;**Explorer**&#x200B;替换，以用于云服务设置。 内部部署设置后，将继续在编辑器中查看和访问存储库。
...
1. 选择&#x200B;**全部替换**&#x200B;可一次性使用指定的替换字符串替换所有搜索文件中的搜索字符串的所有匹配项。 替换所有匹配项后，您将会看到通知。
   ...
   >[!NOTE]
   >
   >要启用&#x200B;**全部替换**&#x200B;按钮，您的文件夹配置文件管理员或系统管理员必须在&#x200B;**Workspace设置**&#x200B;的&#x200B;**常规**&#x200B;选项卡中选择选项&#x200B;**启用全部替换**（对&#x200B;**内部部署**&#x200B;显示为&#x200B;**设置**）。
...
1. 选择&#x200B;**全部替换**&#x200B;可一次性使用替换项替换单个文件中搜索项的所有匹配项。 替换选定文件中的所有匹配项后，您将看到通知。
   ...
   >[!NOTE]
   >
   > 要启用“然后&#x200B;**全部替换**”图标，您的文件夹配置文件管理员或系统管理员必须在&#x200B;**Workspace设置**（显示为&#x200B;**内部部署**&#x200B;的&#x200B;**设置**）的&#x200B;**常规**&#x200B;选项卡下选择选项&#x200B;**启用全部替换**。 如果在替换操作过程中发生错误，将由于XML解析问题或DITA相关错误而跳过这些文件。
