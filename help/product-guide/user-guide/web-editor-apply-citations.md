...
1. 填写&#x200B;**添加引文**&#x200B;对话框中的字段。
   ...
   | **搜索依据** <br>从下拉列表中选择&#x200B;**ISBN**&#x200B;或&#x200B;**DOI**&#x200B;以搜索链接到引文的数字ID。 <br> DOI：数字对象标识符<br> ISBN：唯一数字帐簿标识符 | **搜索依据** <br>从下拉列表中选择&#x200B;**DOI**&#x200B;以搜索链接到引文的数字ID。 | **搜索依据** <ul><li>从下拉列表中选择&#x200B;**DOI**&#x200B;或&#x200B;**PubMed ID**&#x200B;以搜索链接到引文的数字ID。</li><li>从下拉列表中选择&#x200B;**任何字段**&#x200B;以搜索所有日志字段，如&#x200B;*Title*、*Journal title*、*Author*、*Year*、*Volume*、*Number*&#x200B;和&#x200B;*Pages*。<br> 搜索会根据输入的文本返回最接近的匹配引用。</li> |
