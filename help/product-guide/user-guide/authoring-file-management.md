...
- *在同一位置拖放*：为您提供了&#x200B;**覆盖现有文件\(s\)**&#x200B;和&#x200B;**保留两个文件\(s\)**&#x200B;的选项。
...
*在不同的位置拖放文件*：为您提供了&#x200B;**覆盖现有文件\(s\)**&#x200B;和&#x200B;**将文件移动到新位置\(s\)的选项**。
...
1. 此时会根据您的设置显示“批量移动工具”页面。 在&#x200B;**批量移动工具**&#x200B;页面上提供以下详细信息：
   ...
   >[!TIP]
   >
   > 选择 <img src="images/info-icon.svg" width="25">位于任何字段附近，以查看有关它的更多详细信息。
