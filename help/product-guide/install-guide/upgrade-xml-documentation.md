...
您可以将当前版本的Experience Manager Guides升级到版本4.4.0：
...
1. **DAM更新资产工作流\(Post-processing changes\)：**
...
1. 选择&#x200B;**DAM更新资产工作流**。
1. 单击&#x200B;**编辑**。
1. 如果&#x200B;**DXML Post Process Initiator**&#x200B;组件存在，请确保已同步自定义项。
1. 如果&#x200B;**DXML Post Process Initiator**&#x200B;组件不存在，请执行以下步骤将其插入：
